...
<nav class="navbar custom-navbar navbar-expand-lg py-2 bg-success" >
    ...
    <a href="javascript:void(0);" class="menu_toggle"><i class="fa fa-align-left"></i></a>
        <a href="dashboard.php" class="navbar-brand"><strong>Smart Scrap Management System</strong></a>
        <div id="navbar_main">
...
{ 
  ...
  ?>
                             ...
                             <a href="view-complain-detail.php?editid=<?php echo htmlentities($row->compid); ?>&comid=<?php echo htmlentities($row->ComplainNumber); ?>" class="list-group-item list-group-item-action d-flex">
                                    <div class="list-group-headig" style="color:black;"><?php echo $row->ComplainNumber; ?>-----</div>
                                     
                                             <br><div class="list-group-heading"> <?php echo $row->FullName;?><small><?php echo $row->DateofRequest;?></small></div>
