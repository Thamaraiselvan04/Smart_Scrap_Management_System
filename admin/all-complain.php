...
<head>
    ...
    <title>All Lodged Request</title>
...
<?php } else { ?>                  <td><?php  echo htmlentities($row->Status);?> (Assign to <?php  echo htmlentities($row->AssignTo);?>)
                  ...
                  <td>
  <a href="view-complain-detail.php?editid=<?php echo htmlentities($row->compid); ?>&comid=<?php echo htmlentities($row->ComplainNumber); ?>" class="btn btn-primary btn-sm">View</a>
  <a href="all-complain.php?delid=<?php echo htmlentities($row->compid); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this request?');">
