                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="card stat-card traffic">
                            <div class="card-body">
                                <?php 
                                $sql ="SELECT ID FROM tbllodgedcomplain WHERE UserID=:uid";
                                $query = $dbh->prepare($sql);
                                $query->bindParam(':uid', $uid, PDO::PARAM_STR);
                                $query->execute();
                                ...
                                <h2><?php echo htmlentities($totalRequest);?></h2>
                                <a href="lodged-complain-history.php?type=all">View Detail <i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="card stat-card sales">
                            <div class="card-body">
                                <?php 
                                $sql ="SELECT ID FROM tbllodgedcomplain WHERE UserID=:uid AND (Status IS NULL OR Status='')";
                                $query = $dbh->prepare($sql);
                                $query->bindParam(':uid', $uid, PDO::PARAM_STR);
                                $query->execute();
                                $newRequest = $query->rowCount();
                                ?>
                                <h6>New Requests</h6>
                                <h2><?php echo htmlentities($newRequest);?></h2>
                                <a href="lodged-complain-history.php?type=new">View Detail <i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="card stat-card email">
                            <div class="card-body">
                                ...
                                <h2><?php echo htmlentities($completedRequest);?></h2>
                                <a href="lodged-complain-history.php?type=completed">View Detail <i class="fas fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
