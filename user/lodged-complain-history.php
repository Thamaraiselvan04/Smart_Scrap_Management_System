...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="javascript:void(0);">Request</a>
</nav>
...
<td><a href="view-lodged-complain-detail.php?editid=<?php echo htmlentities($row->ID);?>&comid=<?php echo htmlentities($row->ComplainNumber);?>" class="btn btn-primary">View</a></td>
</tr>
